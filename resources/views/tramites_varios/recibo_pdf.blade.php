...
<body>
    ...
    <table class="chk-grid">
        <tr>
            <td style="width: 45%; border-right: 1px solid #cbd5e1;">
                <strong style="color: #475569; font-size: 7pt; text-transform: uppercase; display: block; margin-bottom: 2px;">Servicios Incluidos:</strong>
            ...
            <td style="width: 55%;">
                <strong style="color: #475569; font-size: 7pt; text-transform: uppercase; display: block; margin-bottom: 2px;">Entrega / Destino:</strong>
    ...
    <table style="width: 100%; border-collapse: separate; border-spacing: 4px 0;">
        <tr>
            <td style="width: 58%; vertical-align: top;">
                <div class="box-text">
                    <strong style="color: #475569; font-size: 7pt; text-transform: uppercase; display: block; margin-bottom: 2px;">Observaciones Internas:</strong>
    ...
    <table class="sig-table">
        <tr>
            ...
            <td>
                <div class="sig-line">Firma Notario / Responsable<br><span style="font-size: 7pt; color: #475569; text-transform: none; font-weight: normal;">{{ App\Models\User::find($tramite->id_usuario)->name ?? 'Personal Autorizado' }}</span></div>
            </td>
        </tr>
    </table>
