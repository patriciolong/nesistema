                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="md:col-span-1 bg-gray-50 rounded-xl p-5 border border-gray-200">
                            ...
                            <div class="mb-5">
                                <label for="tv_abono_tramite" class="block text-sm font-bold text-gray-700 mb-1">Abono Inicial Inmediato ($)</label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <span class="text-emerald-500 sm:text-sm font-bold">$</span>
                                    </div>
                                    <input id="tv_abono_tramite" type="number" step="0.01" name="tv_abono_tramite" value="{{ old('tv_abono_tramite', 0) }}" oninput="calcularSaldo()"
                            ...
                            <div class="pt-4 border-t border-gray-200">
                                <label for="tv_saldo" class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Saldo a Cartera (Por Cobrar)</label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
